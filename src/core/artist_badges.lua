...
BM.add_artist_badge('Conomon', 'Art by ChubbyMeel')
BM.add_artist_badge('Kokomon', 'Art by ChubbyMeel')
BM.add_artist_badge('Lopmon', 'Art by ChubbyMeel')
BM.add_artist_badge('Lopmon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Terriermon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Turuiemon', 'Art by ChubbyMeel')
BM.add_artist_badge('Wendigomon', 'Art by ChubbyMeel')
BM.add_artist_badge('Antylamon', 'Art by ChubbyMeel')
BM.add_artist_badge('Cherubimon (Good)', 'Art by ChubbyMeel')
BM.add_artist_badge('Cherubimon (Evil)', 'Art by ChubbyMeel')
BM.add_artist_badge('Keramon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Gomamon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Salamon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Gatomon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Palmon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Togemon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Lillymon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Seadramon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Crabmon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Numemon X', 'Art by ChubbyMeel')
BM.add_artist_badge('Curimon', 'Art by ChubbyMeel')
BM.add_artist_badge('Gurimon', 'Art by ChubbyMeel')
BM.add_artist_badge('Gammamon', 'Art by ChubbyMeel')
BM.add_artist_badge('GulusGammamon', 'Art by ChubbyMeel')
BM.add_artist_badge('BetelGammamon', 'Art by ChubbyMeel')
BM.add_artist_badge('KausGammamon', 'Art by ChubbyMeel')
BM.add_artist_badge('WezenGammamon', 'Art by ChubbyMeel')
BM.add_artist_badge('Canoweissmon', 'Art by ChubbyMeel')
BM.add_artist_badge('Regulusmon', 'Art by ChubbyMeel')
BM.add_artist_badge('Siriusmon', 'Temporary Art')
BM.add_artist_badge('Arcturusmon', 'Temporary Art')
BM.add_artist_badge('Proximamon', 'Temporary Art')